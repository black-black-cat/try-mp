 ...
 * 例子：
 *
 * var browser = require("lib/util/browser"); // 返回一个对象，可以直接读属性
 * console.log(browser.wx); // 如果是微信，则值为true
 *
 */
...
var gtIOS9 = function() {
    if((navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPod/i))) {
        return Boolean(navigator.userAgent.match(/OS [0-9]_\d[_\d]* like Mac OS X/i));
    } else {
        return false;
    }
}
