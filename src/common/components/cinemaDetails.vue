    ...
    <div class="m-movie-detail">
        ...
        <div class="address vh-between">
            <div>
                ...
                <div class="time vh-left" v-if="false">
        ...
        <div class="service" v-show="cinema.feature_service && cinema.feature_service.length">
        ...
        <div class="cinemaInfo" v-if="cinema.intro">
            <span class="service-name"><span class="name vh-center">影院信息</span></span>
            <span class="service-explain" v-html="cinema.intro"></span>
        </div>
    </div>
</template>
<script>
