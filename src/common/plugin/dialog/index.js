...
import { isFunction, isObject, isArray, isNumber } from "lib/util/dataType";
import content from "./content.vue";
import toast from './toast.vue';
import { bus, bind } from 'lib/comp/bus';
...
const common = function(msg, config = {}, type){
    return new Promise((resolve, reject) => {
        ...
        m_dialog.show(opts.left, opts.top, null, null, config.afterShow);
